...
class SAC(nn.Module):
    def __init__(self, writer, device, state_dim, action_dim, args):
        ...
        self.target_q_1 = self.target_q_1.model
        ...
        self.target_q_2 = self.target_q_2.model
    ...
    def q_update(self, Q, q_optimizer, states, actions, rewards, next_states, dones):
        ...
        with torch.no_grad():
            ...
            next_s_a = StateAction2EqualSA(next_states,next_actions)
        ...
        now_s_a = StateAction2EqualSA(states,actions)
        # q = Q(states, actions)
        q = Q.forward(now_s_a)
    ...
    def actor_update(self, states):
        ...
        now_s_a = StateAction2EqualSA(states, now_actions)
